...
namespace Diplom.Controllers
{
    public class ZadachisController : Controller
    {
        ...
        public IActionResult Osmisleno(XLWorkbook workbook)
        {
            ...
            public IActionResult Export()
         {
            ...
            using (var workbook = new XLWorkbook())
            {
                ...
                var result_query = _context.Zadachis.Where(e => e.Status.Status_name == "Завершен" && e.Date_Close == test).ToList();
                ...
                #endregion
                #region Body
                foreach (var zadachii in result_query )
                {
                    currentRow++;
        ...
        public IActionResult Export1()
        {
            ...
            using (var workbook = new XLWorkbook())
            {
                ...
                var result_query = _context.Zadachis.Where(e => e.Status.Status_name == "Завершен").ToList();
